...
local SetupPages = {
   {
      ...
      fields = {
         { t = "RB", x = 21,  y = 24, i=2, inc = incChan, conv = function (v) return incChan(v,0) - 31 end },
         { t = "mW", x = 75,  y = 24, i=1, inc = incPower, conv = function (v) return powerLevels[1 + incPower(v, 0)] end },
      },
      read  = MSP_VTX_CONFIG,
